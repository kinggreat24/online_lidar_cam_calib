...
namespace kitti{
    ...
    public:
        ...
        static pcl::PointCloud<pcl::PointXYZI>::Ptr LoadPtCloudTxt(const std::string& path);
        static pcl::PointCloud<pcl::PointXYZI>::Ptr LoadPtCloudPcd(const std::string& path);
