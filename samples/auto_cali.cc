...
int main(int argc, char const* argv[]) {
    ...
    // calibrator.Optimize(optimized_extri);
    calibrator.OptimizeSingleLvlPyr(optimized_extri, phc::utils::Config::Get<int>("optimizer.pyramid_level"));
    // calibrator.OptimizeMultiLvlPyr(optimized_extri, phc::utils::Config::Get<int>("optimizer.pyramid_depth")); 
    ...
    evaluator.PlotHist(redisual_recorder->GetResidualBeforeOpt());
    evaluator.PlotHist(redisual_recorder->GetResidualAfterOpt());
