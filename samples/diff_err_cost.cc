...
int main(int argc, char const* argv[]) {
    ...
    phc::utils::Vec3DataBag::Ptr vec3_bag(new phc::utils::Vec3DataBag("diff_err_cost"));
    ...
    // 0.125 0.003 lvl3
    // 0.0625 0.0015 lvl2
    // 0.03125 0.00075 lvl1
    // 0.015625 0.000375 lvl0
    // std::vector<Eigen::Isometry3f> extri_errors = phc::utils::Rand::NormalIsometry3f(0.0f, 0.015625f, 0.0f, 0.000375f, 500);
    ...
    // 0.03125 0.00075 lvl1
    // 0.015625 0.000375 lvl0
    // std::vector<Eigen::Isometry3f> extri_errors = phc::utils::Rand::UniformIsometry3f(0.25f, 0.025f, 500);
    // extri_errors.push_back(Eigen::Isometry3f::Identity()); // original

    

    // std::vector<Eigen::Isometry3f> extri_errors = phc::utils::SingleAxisIsoGrid(0.3, 20, 0.03, 20, "y");
    std::vector<Eigen::Isometry3f> extri_errors = phc::utils::RandIsoGrid(0.0125, 20, 0.00125, 20);
    for (int i = 0; i < extri_errors.size(); ++i) {
        ...
        vec3_bag->AddData(trans_dist, rot_dist, origin_cost);
    }
